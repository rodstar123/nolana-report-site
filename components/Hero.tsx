...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      {/* Gradient overlay — opaque left (text), transparent right (image peeks) */}
      <div
        className="absolute inset-0 z-[1]"
        aria-hidden="true"
        style={{
          background:
            "linear-gradient(to right, rgba(237,232,224,0.95) 0%, rgba(237,232,224,0.85) 50%, rgba(237,232,224,0.3) 100%)",
        }}
      />
      {/* Mobile: more opaque so text stays readable */}
      <div
      ...
      <div
        ...
        style={{ minHeight: "550px" }}
      >
        <div className="w-full max-w-7xl mx-auto px-5 sm:px-10 lg:px-16 py-14 sm:py-18 lg:py-24">
